...
public class FinishedInstanceInteractionClass {
	...
	public boolean isMe( InteractionClassHandle interactionClass ) {
		System.out.println(" >> finishedInstanceInteractionHandle " + finishedInstanceInteractionHandle + " " + interactionClass );
	...
	public void send( String coreSerial, String instanceSerial ) throws Exception {
		HLAunicodeString coreValue = encodec.createHLAunicodeString( coreSerial );
